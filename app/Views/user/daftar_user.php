                ...
                <tbody>
                    ...
                    <?php foreach ($user as $u) : ?>
                        <tr>
                            ...
                            <td>
                                <button type="button" class="btn badge bg-warning" data-bs-toggle="modal" data-bs-target="#modaltambah_user" onclick="edit_user(<?php echo $u['id_user'] ?>)">Edit</button>
...
<?= $this->include('/user/modal_add_edit_user'); ?>
