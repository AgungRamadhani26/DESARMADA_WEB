    ...
    <div class="card">
        <div class="card-header bg-light">
            ...
            <div>
                ...
                <button type="button" class="btn badge bg-primary" data-bs-toggle="modal" data-bs-target="#modaltambah_lokasi">
                    Tambah
                </button>
            </div>
        </div>
                ...
                <tbody>
                    ...
                    <?php foreach ($lokasi as $l) : ?>
                        <tr>
                            ...
                            <td>
                                <button type="button" class="btn badge bg-warning" data-bs-toggle="modal" data-bs-target="#modaledit_lokasi" onclick="edit_lokasi(<?php echo $l['id_departemen'] ?>)">Edit</button>
