                    ...
                    <div class="card aktif">
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-9">
                                    <h6 class="font-bold">Pengembalian Mobil</h6>
                                    <h6 class="font-extrabold mb-0 text-white">Belum Kembali: <?= $jlh_mblBLM_Kembali['jumlah'] ?></h6>
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <tbody>
                                    ...
                                    <?php foreach ($mobil_dipinjam as $mbl) : ?>
                                        <tr>
                                            <td><?= $i++ ?></td>
                                            <td>
                                                <a href="/peminjaman/kembalikan_kendaraan/<?= $mbl['id_peminjaman'] ?>" class="btn btn-success btn-sm"><span class="material-icons">reply</span>Kembalikan</a>
                                            </td>
