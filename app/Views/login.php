...
<body>
    <section class="text-center">
        <!-- Background image -->
        <div class="p-5 bg-image" style="background-image: url('/assets/images/img_tampilan/BG-Login.jpg'); height: 320px;"></div>
        <!-- Background image -->
        <center>
            <div class="card card-login mx-4 mx-md-5 px-md-5 shadow-5-strong" style="margin-top: -120px; background: hsla(0, 0%, 100%, 0.5); backdrop-filter: blur(100px); max-width:1000px">
                <center>
