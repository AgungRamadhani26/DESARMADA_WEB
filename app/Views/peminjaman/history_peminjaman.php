                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-4">
                            ...
                            <a href="/peminjaman/eksport_all_pdf" class="btn btn-success btn-sm position-absolute top-50 end-10 mt-1"><i class="bi bi-file-earmark-pdf-fill"></i> Export Data PDF</a>
                        </div>
                    </div>
                </div>
            </div>
