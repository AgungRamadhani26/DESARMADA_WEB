            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-4">
                            <a href="/peminjaman/eksport_all_exc" class="btn btn-success btn-sm position-absolute bottom-50 end-10 mb-1"><span class="material-icons">description</span>Export Excel</a>
                            <a href="/peminjaman/eksport_all_pdf" class="btn btn-success btn-sm position-absolute top-50 end-10 mt-1"><span class="material-icons">picture_as_pdf</span>Export PDF</a>
                        </div>
                    </div>
                </div>
            </div>
